        ...
        {!smallWidth && <Grid item md={3}>
          <Card className={classes.card}>
            <CardMedia className={classes.image}
              image={require('../data/images/myb_picture.png')}
              title="My Picture"
            />
          </Card>
        </Grid>}
          ...
          <Grid container direction="column" alignItems="center">
            <Grid item style={{ paddingTop: smallWidth ? 15 : 5, }}>
              ...
              <Typography variant="subtitle1" color="textSecondary" style={{ marginTop: 30 }}>
                Feel free to <StyledLink href="mailto:mohamedyoussefbouzaabia@gmail.com">contact me</StyledLink> if you have any questions.
                </Typography>
            ...
            <Grid item>
              <Grid container direction="row" alignContent="center" style={{ marginTop: 40 }} justify="space-around">
                ...
                <Grid item>
                  <Button variant="outlined" color="secondary" className={classes.button} target="_blank" href="https://github.com/BOUZAABIAM"><GitHubIcon className={classes.icon} ></GitHubIcon>
                    Github
                </Button>
                </Grid>
                <Grid item>
                  <Button variant="outlined" color="secondary" className={classes.button} target="_blank" href="https://www.linkedin.com/in/bouzaabia-mohamed-youssef-080699117/"><LinkedInIcon className={classes.icon} ></LinkedInIcon>
                    LinkedIn
                </Button>
                </Grid>
              </Grid>
